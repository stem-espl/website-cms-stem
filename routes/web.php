...
*/ 
	...
	******************** Admin Routes ********************** =======================================================*/ 
	...
	Route::group( [ "prefix" => "admin", "middleware" => ["auth:admin", "checkstatus", "setLfmPath"], ], function () { 
			...
			Route::get("/heading", "Admin\BasicController@heading")->name( "admin.heading" )->middleware('can:general-settings'); 
			Route::post( "/heading/{langid}/update", "Admin\BasicController@updateheading" )->name("admin.heading.update")->middleware('can:general-settings'); 
			// Admin Scripts Routes 
			Route::get("/script", "Admin\BasicController@script")->name( "admin.script" )->middleware('can:general-settings'); 
			Route::post( "/script/update", "Admin\BasicController@updatescript" )->name("admin.script.update")->middleware('can:general-settings'); 
			// Admin Social Routes 
			...
			Route::get( "/service/settings", "Admin\ServiceController@settings" )->name("admin.service.settings"); Route::post( "/service/updateSettings", "Admin\ServiceController@updateSettings" )->name("admin.service.updateSettings"); 
			...
			Route::get("/document_category", "Admin\DocumentController@category_index")->name( "admin.dcategory.index" ); 
			Route::post( "/document_category/store", "Admin\DocumentController@category_store" )->name("admin.dcategory.store"); 
			Route::post( "/document_category/update", "Admin\DocumentController@category_update" )->name("admin.dcategory.update"); 
			Route::post( "/document_category/delete", "Admin\DocumentController@category_delete" )->name("admin.dcategory.delete"); 
			Route::post( "/document_category/bulk-delete", "Admin\DocumentController@category_bulkDelete" )->name("admin.dcategory.bulk.delete"); 
			...
			Route::post( "/tender/bulk-delete", "Admin\TendersController@bulkDelete" )->name("admin.tenders.bulk.delete")->middleware('can:tenders'); // Admin Blog Category Routes 
			...
			Route::post( "/event/categories/bulk-delete", "Admin\EventCategoryController@bulkDelete" )->name("admin.event.category.bulk.delete"); // Admin Event Routes 
