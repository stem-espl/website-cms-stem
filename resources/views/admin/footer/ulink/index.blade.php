...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="javascript:void(0)">Userful Links</a>
      </li>
    </ul>
  </div>
  <div class="row">
        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="javascript:void(0)" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> Add Userful Link</a>
                </div>
            </div>
        </div>
        <div class="card-body">
