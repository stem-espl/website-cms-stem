  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Leadership Category</h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="{{ route('admin.leadership_category.store', ['language' => request()->input('language')]) }}" method="post">
          @csrf
