...
@section('content')
  <div class="page-header">
    <h4 class="page-title">Documents Categories</h4>
    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                    <a href="javascript:void(0)" class="btn btn-primary float-right btn-sm" data-toggle="modal" data-target="#createModal"><i class="fas fa-plus"></i> Add Document Category</a>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($documentCat) == 0)
                <h3 class="text-center">NO DOCUMNET CATEGORY FOUND</h3>
              @else
                <div class="table-responsive">
                  <table class="table table-striped mt-3">
                    ...
                    <tbody>
                      @foreach ($documentCat as $key => $dcategory)
                        <tr>
                          <td>
                            <input type="checkbox" class="bulk-check" data-val="{{$dcategory->id}}">
                          </td>
                          <td>{{convertUtf8($dcategory->title)}}</td>
                          <td>
                            @if ($dcategory->status == 1)
                          ...
                          <td>
                            ...
                            <form class="deleteform d-inline-block" action="{{route('admin.dcategory.delete')}}" method="post">
                              @csrf
                              <input type="hidden" name="dcategory_id" value="{{$dcategory->id}}">
        ...
        <div class="card-footer">
          <div class="row">
            <div class="d-inline-block mx-auto">
              {{$documentCat->appends(['language' => request()->input('language')])->links()}}
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Add Document Category</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="ajaxForm" class="modal-form create" action="{{route('admin.dcategory.store')}}" method="POST">
            @csrf
  ...
  <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Edit Document Category</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="ajaxEditForm" class="" action="{{route('admin.dcategory.update')}}" method="POST">
            @csrf
            <input id="indcategory_id" type="hidden" name="dcategory_id" value="">
            <div class="form-group">
              <label for="">Name in English**</label>
