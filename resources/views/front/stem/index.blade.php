      ...
      @foreach ($event as $newsdata ) 
            <div class="col-md-6 col-lg-6 col-xl-4">
              <div class="news-wrapper mrb-30 mrb-sm-40">
                <a href="{{ route('front.news.details', ['id' => $newsdata->id]) }}"> <div class="news-thumb">
                ...
                <div class="news-details">
                  <div class="news-description mb-20">
                    <h4 class="the-title mrb-30">    <a href="{{ route('front.news.details', ['id' => $newsdata->id]) }}">{{$newsdata->title}}</a></h4>
